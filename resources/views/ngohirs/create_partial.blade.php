                                ...
                                <div class="col-md-12">
                                    <div id="survivor_present_address" class="row addresser">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            {!! Form::text('survivor_address_postal_code[]', '', ['class' => 'form-control field6']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="survivor_native_address" class="row addresser">
                                        ...
                                        <div class="col-md-3">
                                            {!! Form::label('survivor_address_postal_code', 'Postal Code:', ['class' => 'control-label']) !!}
                                            {!! Form::input('text', 'survivor_address_postal_code[]', '', ['class' => 'form-control field6']) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div id="survivor_new_address" class="row addresser">
                            ...
                            <div class="col-md-3">
                                ...
                                <!-- {!! Form::text('survivor_address_postal_care', '', ['class' => 'form-control']) !!}
