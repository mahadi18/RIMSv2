        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <?php //var_dump($information['ngohir']->interview_info); die; ?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('name_of_the_survivor_at_source', 'Survivor’s Name During Rescue:', ['class' => 'col-md-3 col-lg-3 control-label']) !!}
                                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('name_of_the_survivor_at_destination', 'Survivor’s Name During Investigation:', ['class' => 'col-md-3 col-lg-3 control-label']) !!}
                                    <div class="col-sm-9">
                                        {!! Form::text('name_of_the_survivor_at_destination', $information['ngohir']->name_of_the_survivor_at_destination or old('name_of_the_survivor_at_destination'), ['class' => 'form-control']) !!}
                                        <p class="help-block"><i>(as recorded in Investigation Repot in {{ $litigation->country($litigation->country_of_origin) }})</i></p>
                                    </div><span class="mandatory">*</span>
                                </div>
                            </div>
                        </div>
                ...
                {{-- @if( count($information['ngohir_addresses']) )  --}}
                                ...
                                <div class="col-md-12">
                                    <div id="survivor_present_address" class="row addresser-edit ">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            {!! Form::text('survivor_address_postal_code[]', $information['ngohir_addresses'][0]->postal_code, ['class' => 'form-control field6']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="survivor_native_address" class="row row addresser-edit">
                                        ...
                                        <div class="col-md-3">
                                            {!! Form::label('survivor_address_postal_code', 'Postal Code:', ['class' => 'control-label']) !!}
                                            {!! Form::text('survivor_address_postal_code[]', $information['ngohir_addresses'][1]->postal_code, ['class' => 'form-control field6']) !!}
