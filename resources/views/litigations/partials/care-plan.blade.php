...
<div class="care-plans">
    ...
    padding-right: 50px; margin-top: 30px" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div data-date-viewmode="years" style="width: 220px" data-date-format="dd-mm-yyyy" data-date="{{ date('d-m-Y') }}" class="input-append date">
                                            {!! Form::text('date', '', ['size' => '16', 'class' => 'form-control','id'=>'datetimepicker']) !!}
                                            <span class="input-group-btn add-on">
                                                {!! Form::button('<i class="fa fa-calendar-plus-o"></i>', ['class' => 'btn btn-success' , 'id'=>'datetimepicker1']) !!}
                                            </span>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <label>Action Summary <p style="display: inline; color: red;">*</p></label>
                            </div>
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <label>Notes <p style="display: inline; color: red;">*</p></label>
                            </div>
                            <div class="col-lg-12">
