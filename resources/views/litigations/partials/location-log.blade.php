                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div data-date-viewmode="years" data-date-format="dd-mm-yyyy"
                                         data-date="{{ date('d-m-Y') }}"
                                         class="input-append date " style="width: 255px"> <!-- Ripon remove the class  -->
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div data-date-viewmode="years" data-date-format="dd-mm-yyyy"
                                         data-date="{{ date('d-m-Y') }}"
                                         class="input-append date" style="width: 255px">
                                        {!! Form::text('transfer_date', '', ['size' =>
                                        '16',
                                        'class' =>
                                        'form-control' ,'id'=>'datetimepicker2']) !!}
                                                            <span class="input-group-btn add-on">
                                                                {!! Form::button('<i class="fa fa-calendar-plus-o open-datetimepicker"></i>', ['class' => 'btn btn-success', 'id'=>'datetimepicker11']) !!}
                                                            </span>
                                    </div>
                                </div>
                            </div>
...
$('#datetimepicker11').click(function(event){
