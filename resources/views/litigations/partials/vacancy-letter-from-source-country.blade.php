...
<?php foreach ($information['forms'] as $form) {
        ...
        <div class="" role="tab" id="heading<?php echo $form->id; ?>"><a class="" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $form->id; ?>" aria-expanded="false" aria-controls="collapse<?php echo $form->id; ?>"><h2><?php if ($form->status) {
        ...
        <div class="col-lg-6">
                    ...
                    <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="<?php date('d-m-Y') ?>"  class="input-append date dpYears">
                        <input name="field-21" type="text" value="<?php echo $field->value; ?>" size="16" class="form-control">
                            <span class="input-group-btn add-on">
                                <button class="btn btn-success" type="button"><i class="fa fa-calendar-plus-o"></i>
                                </button>
                            </span>
                    </div>
                </div>
            ...
            <div class="modal fade bs-example-modal-lg<?php echo $form->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
