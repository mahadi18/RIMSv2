...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ui-widget form-group">
                                ...
                                {!! Form::label('name_during_rescue', 'Name During Rescue:', ['class' => 'control-label']) !!}
                                <span class="mandatory">*</span>
                                </div>
                                <div id="someElem" class="col-sm-10">
                                    {!! Form::text('name_during_rescue', '', ['class' => 'form-control', 'id'=>'q']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" id="suggestion"
                                style="border: 1px;">
                                            ...
                                            <div class="col-md-12">
                                                <div id="rescue_address" class="form-group addresser row">
                                                    <div class="col-md-4 countries">
                                                        ...
                                                        {!! Form::select('rescued_from_country', get_countries_list(), 2, ['class' => 'form-control m-bot15', 'disabled' => true]) !!}
                                                    </div>

                                                    <div class="col-md-4 states">
                                                        {!! Form::label('rescued_from_state', 'State/ Division') !!}
                                                        {!! Form::select('rescued_from_state', states_of_country(2), null, ['class' => 'form-control m-bot15']) !!}
                                                    </div>

                                                    <div class="col-md-4 districts">
                                                        {!! Form::label('rescued_from_district', 'District') !!}
                                                        {!! Form::select('rescued_from_district', ['-- Please select State --'], null, ['class' => 'form-control m-bot15']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $( "#q" ).autocomplete("widget").addClass("fixedHeight");

        $( "#q" ).autocomplete( "#q", "appendTo", "#someElem" );
